...
const sessionClient = new dialogflow.SessionsClient({keyFilename: "venombot-kwan-bc39ad17ed7b.json"});
...
async function connectToWhatsApp () {
    ...
    conn.on('chat-update', async chatUpdate => {
        if (chatUpdate.messages && chatUpdate.count) {
            ...
            let textoResposta = await executeQueries("venombot-kwan", message.key.remoteJid, [JSON.stringify(message.message.conversation)], 'pt-BR');
